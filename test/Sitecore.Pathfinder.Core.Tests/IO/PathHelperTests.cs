...
namespace Sitecore.Pathfinder.IO
{
    ...
    public class PathHelperTests : Tests
    {
        ...
        public void GetItemNameTests()
        {
            ...
            Assert.Throws<ArgumentException>(() => PathHelper.GetItemName(new SourceFile(Services.FileSystem, string.Empty, string.Empty, string.Empty)));
        }
        ...
        public void GetItemPathTests()
        {
            ...
            Assert.Throws<ArgumentException>(() => PathHelper.GetItemPath(Project.Empty, new SourceFile(Services.FileSystem, string.Empty, string.Empty, string.Empty), string.Empty, string.Empty));
        }
