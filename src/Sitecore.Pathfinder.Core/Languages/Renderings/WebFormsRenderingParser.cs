...
namespace Sitecore.Pathfinder.Languages.Renderings
{
    public abstract class WebFormsRenderingParser : RenderingParser
    {
        ...
        protected WebFormsRenderingParser([NotNull] IConfiguration configuration, [NotNull] IFactory factory, [NotNull] string fileExtension, [NotNull] string templateIdOrPath) : base(configuration, factory, fileExtension, templateIdOrPath)
        {
        }
