...
namespace Sitecore.Pathfinder.Languages.Yaml
{
    ...
    public class YamlTemplateTextNodeParser : TemplateTextNodeParserBase
    {
        ...
        public YamlTemplateTextNodeParser([NotNull] IFactory factory, [NotNull] ITraceService trace, [NotNull] IPipelineService pipelines, [NotNull] IReferenceParserService referenceParser, [NotNull] ISchemaService schemaService) : base(factory, trace, pipelines, referenceParser, schemaService, Constants.TextNodeParsers.Templates)
        {
        }
