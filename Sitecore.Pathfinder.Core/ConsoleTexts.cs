namespace Sitecore.Pathfinder.Diagnostics
{
  public static class ConsoleTexts
  {
    ...
    // Messages
    public const int Text4000 = 4000;

    public const int Text4001 = 4001;

    public const int Text4002 = 4002;

    public const int Text4003 = 4003;

    public const int Text4004 = 4004;

    public const int Text4005 = 4005;

    public const int Text4006 = 4006;

    public const int Text4007 = 4007;
  }
}
