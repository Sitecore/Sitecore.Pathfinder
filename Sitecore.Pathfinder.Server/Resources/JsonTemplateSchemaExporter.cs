namespace Sitecore.Pathfinder.Resources
{
  ...
  public class JsonTemplateSchemaExporter : IResourceExporter
  {
    ...
    protected virtual void WriteChildren([NotNull] JsonTextWriter output, [NotNull] Database database, [NotNull] Template template)
    {
    ...
    protected virtual void WriteDropListProperty([NotNull] JsonTextWriter output, [NotNull] Database database, [NotNull] TemplateField field, bool useId)
    {
    ...
    protected virtual void WriteItemPath([NotNull] JsonTextWriter output, [NotNull] Database database, [NotNull] Template template)
    {
    ...
    protected virtual void WriteItemsDefinition([Sitecore.NotNull] JsonTextWriter output, [Sitecore.NotNull] IEnumerable<Template> templates)
    {
      output.WriteStartObject("Items");
      output.WritePropertyString("type", "array");
    ...
    protected virtual void WriteSchema([Sitecore.NotNull] JsonTextWriter output, [NotNull] Database database, [Sitecore.NotNull] IEnumerable<Template> templates)
    {
      output.WriteStartObject();
    ...
    protected virtual void WriteTemplates([NotNull] JsonTextWriter output, [NotNull] Database database, [NotNull] IEnumerable<Template> templates)
    {
      foreach (var template in templates)
      {
