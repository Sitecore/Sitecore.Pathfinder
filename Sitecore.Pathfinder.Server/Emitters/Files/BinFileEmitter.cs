namespace Sitecore.Pathfinder.Emitters.Files
{
  ...
  public class BinFileEmitter : EmitterBase
  {
    ...
    public override void Emit(IEmitContext context, IProjectItem projectItem)
    {
      ...
      var destinationFileName = "/" + PathHelper.NormalizeItemPath(PathHelper.UnmapPath(context.Project.ProjectDirectory, binFile.TextNode.TextDocument.SourceFile.SourceFileName));
      ...
      try
      {
        ...
        context.FileSystem.Copy(binFile.TextNode.TextDocument.SourceFile.SourceFileName, destinationFileName);
      }
      catch (Exception ex)
      {
        Log.Error($"Failed to copy assembly: {binFile.TextNode.TextDocument.SourceFile.SourceFileName} -> {destinationFileName}", ex);
      }
    }
  }
}
