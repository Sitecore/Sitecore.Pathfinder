...
namespace Sitecore.Pathfinder.Builders.FieldResolvers
{
    ...
    public class HtmlTemplateFieldResolver : FieldResolverBase
    {
        public HtmlTemplateFieldResolver() : base(Constants.FieldResolvers.Normal)
        {
        }
        ...
        {
            var htmlTemplate = field.Item.HtmlTemplate;
