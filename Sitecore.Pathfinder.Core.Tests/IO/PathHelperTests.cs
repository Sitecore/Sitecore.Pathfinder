namespace Sitecore.Pathfinder.IO
{
  ...
  public class PathHelperTests : Tests
  {
    ...
    public void GetItemNameTests()
    {
      ...
      Assert.AreEqual("test", PathHelper.GetItemName(new SourceFile(this.Services.FileSystem, "\\sitecore\\client\\test.txt")));
      Assert.AreEqual("test", PathHelper.GetItemName(new SourceFile(this.Services.FileSystem, "/sitecore/client/test.txt")));
      Assert.AreEqual("test", PathHelper.GetItemName(new SourceFile(this.Services.FileSystem, "/sitecore/client/test")));
      Assert.AreEqual("test", PathHelper.GetItemName(new SourceFile(this.Services.FileSystem, "test.txt")));
      Assert.AreEqual("test", PathHelper.GetItemName(new SourceFile(this.Services.FileSystem, "test")));
      Assert.Throws<ArgumentException>(() => PathHelper.GetItemName(new SourceFile(this.Services.FileSystem, string.Empty)));
    }
    ...
    public void GetItemPathTests()
    {
      ...
      Assert.AreEqual("/sitecore/client/test", PathHelper.GetItemPath(Project.Empty, new SourceFile(this.Services.FileSystem, "\\sitecore\\client\\test.txt")));
      Assert.AreEqual("/sitecore/client/test", PathHelper.GetItemPath(Project.Empty, new SourceFile(this.Services.FileSystem, "/sitecore/client/test.txt")));
      Assert.AreEqual("/sitecore/client/test", PathHelper.GetItemPath(Project.Empty, new SourceFile(this.Services.FileSystem, "/sitecore/client/test")));
      Assert.AreEqual("/sitecore/test", PathHelper.GetItemPath(Project.Empty, new SourceFile(this.Services.FileSystem, "test.txt")));
      Assert.AreEqual("/sitecore/test", PathHelper.GetItemPath(Project.Empty, new SourceFile(this.Services.FileSystem, "test")));
      Assert.Throws<ArgumentException>(() => PathHelper.GetItemPath(Project.Empty, new SourceFile(this.Services.FileSystem, string.Empty)));
    }
